...
If you don't have Python on your computer we recommend to install it using [PyEnv](https://github.com/pyenv/pyenv). In order to install PyEnv on Mac you can use [brew](https://github.com/rbenv/rbenv) to install it:
